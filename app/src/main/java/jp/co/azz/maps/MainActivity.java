...
public class MainActivity extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng azz = new LatLng(35.712206, 139.706787);
        mMap.addMarker(new MarkerOptions().position(azz).title("株式会社アズ"));
        CameraUpdate cUpdate = CameraUpdateFactory.newLatLngZoom(azz, 21);
